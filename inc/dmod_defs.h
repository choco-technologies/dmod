...
#define DMOD_MAX_FILE_PATH_LENGTH       256
...
#define DMOD_BUILTIN_SIGNATURE_PREFIX   "\021DMBI\022"
...
// TYPE NAME MACROS
#define DMOD_MAKE_DIF_API_TYPE_NAME( MODULE_NAME, NAME )                        dmod_##MODULE_NAME##NAME##_t

// REGISTRATION NAME MACROS
...
// SIGNATURE NAME MACROS
#define DMOD_MAKE_DIF_SIG_NAME( MODULE, API_NAME )                          dmod_##MODULE##API_NAME##_sig
...
#endif
#if defined(ENABLE_DIF_REGISTRATIONS)
#       define _DMOD_DIF_SIGNATURE_REGISTRATION( MODULE, API_NAME, SIGNATURE )        \
        const char* const DMOD_MAKE_DIF_SIG_NAME(MODULE,API_NAME) = SIGNATURE;
#else
#       define _DMOD_DIF_SIGNATURE_REGISTRATION( MODULE, API_NAME, SIGNATURE )        \
        extern const char* const DMOD_MAKE_DIF_SIG_NAME(MODULE,API_NAME);
#endif
#define DMOD_DIF_SIGNATURE_REGISTRATION(MODULE, API_NAME, VERSION)        \
        _DMOD_DIF_SIGNATURE_REGISTRATION( MODULE, API_NAME, DMOD_MAKE_DIF_SIGNATURE(MODULE, VERSION, API_NAME) );

// ==============================================================================
// INPUT/OUTPUT API MACROS
...
#define DMOD_BUILTIN_INPUT_API( MODULE, VERSION, RET, NAME, PARAMS )        \
                _DMOD_INPUT_API( DMOD_MAKE_API_FUNCTION_NAME(MODULE,NAME), DMOD_MAKE_BUILTIN_SIGNATURE(MODULE, VERSION, NAME), DMOD_MAKE_API_REG_NAME(MODULE,NAME), RET, PARAMS )
...
#define DMOD_BUILTIN_OUTPUT_API( MODULE, VERSION, RET, NAME, PARAMS )       \
        _DMOD_OUTPUT_API( DMOD_MAKE_API_FUNCTION_NAME(MODULE,NAME), DMOD_MAKE_BUILTIN_SIGNATURE(MODULE, VERSION, NAME), RET, PARAMS )
...
// ==============================================================================
// DIF API macros 
#define DMOD_DIF_FUNCTION_TYPE_DECLARATION( MODULE_NAME, VERSION, RET, NAME, PARAMS )        \
        typedef RET (*DMOD_MAKE_DIF_API_TYPE_NAME(MODULE_NAME,NAME)) PARAMS;
...
#define DMOD_IRQ_HANDLER( IRQ_NUMBER )        \
        ...
        volatile const Dmod_ApiRegistration_t DMOD_IRQ_MAKE_REG_NAME(IRQ_NUMBER) DMOD_USED_SECTION(".dmod.inputs") = \
        { \
...
#define DMOD_BUILTIN_API( MODULE, VERSION, RET, NAME, PARAMS )      DMOD_BUILTIN_INPUT_API( MODULE, VERSION, RET, NAME, PARAMS )
#elif DMOD_MODULE_EN == ON
#define DMOD_BUILTIN_API( MODULE, VERSION, RET, NAME, PARAMS )      DMOD_BUILTIN_OUTPUT_API( MODULE, VERSION, RET, NAME, PARAMS )
#endif
