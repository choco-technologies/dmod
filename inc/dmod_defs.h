...
#define DMOD_MAL_SIGNATURE_PREFIX	"\021DSAL\022"
...
#define DMOD_MAKE_MAL_API_FUNCTION_NAME( MODULE, NAME )		        mal_##MODULE##NAME
#define DMOD_MAKE_API_REG_NAME( MODULE, NAME )			        MODULE##NAME##_registration
#define DMOD_MAKE_MAL_API_REG_NAME( MODULE, NAME )			mal_##MODULE##NAME##_registration
...
#define DMOD_INPUT_API_GEN( MODULE, VERSION, RET, NAME, PARAMS )        \
...
#define DMOD_MAL_INPUT_API_GEN( MODULE, VERSION, RET, NAME, PARAMS )        \
...
#define DMOD_OUTPUT_API_GEN( MODULE, VERSION, RET, NAME, PARAMS )       \
...
#define DMOD_MAL_OUTPUT_API( MODULE, VERSION, RET, NAME, PARAMS )       \
 ...
 #define DMOD_MAL_OUTPUT_API_GEN( MODULE, VERSION, RET, NAME, PARAMS )       \
