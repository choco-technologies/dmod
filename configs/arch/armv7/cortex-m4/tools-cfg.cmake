...
set(CPUCONFIG_CFLAGS "-mcpu=cortex-m4 -mthumb -mno-unaligned-access -DGCC_ARMCM4 ${COMMON_DEFINE_FLAGS} -mpic-data-is-text-relative -mabi=aapcs" CACHE STRING "C compiler flags")
set(CPUCONFIG_CXXFLAGS "-mcpu=cortex-m4 -mthumb -mno-unaligned-access -DGCC_ARMCM4 ${COMMON_DEFINE_FLAGS} -mpic-data-is-text-relative -mabi=aapcs" CACHE STRING "C++ compiler flags")
set(CPUCONFIG_ASMFLAGS "-mcpu=cortex-m4 -mthumb -mno-unaligned-access -DGCC_ARMCM4 ${COMMON_DEFINE_FLAGS} -mpic-data-is-text-relative -mabi=aapcs" CACHE STRING "ASM compiler flags")
set(CPUCONFIG_LDFLAGS "-mcpu=cortex-m4 -mthumb -mno-unaligned-access -Wl,--gc-sections -Wl,-static -mabi=aapcs" CACHE STRING "Linker flags")
