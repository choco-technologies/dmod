...
elseif(CMAKE_BUILD_TYPE STREQUAL "Release" OR CMAKE_BUILD_TYPE STREQUAL "RelWithDebInfo")
    set(OPTIMIZATION_FLAGS "-O2" CACHE STRING "Optimization flags" FORCE)
else()
    set(OPTIMIZATION_FLAGS "-O2" CACHE STRING "Optimization flags" FORCE)
endif()
...
set(CPUCONFIG_CFLAGS "-fno-builtin-memset-mcpu=cortex-m4 -mthumb -mno-unaligned-access -DGCC_ARMCM4 ${COMMON_DEFINE_FLAGS} -mpic-data-is-text-relative -mabi=aapcs ${FPU_FLAGS}" CACHE STRING "C compiler flags")
...
set(CMAKE_ASM_FLAGS_DEBUG "${OPTIMIZATION_FLAGS} ${CPUCONFIG_ASMFLAGS} -g" CACHE STRING "ASM compiler flags for Debug")
