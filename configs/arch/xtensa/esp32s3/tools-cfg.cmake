...
set(CPUCONFIG_CFLAGS "-mlongcalls -fstrict-volatile-bitfields -Wno-frame-address ${COMMON_DEFINE_FLAGS}" CACHE STRING "C compiler flags")
set(CPUCONFIG_CXXFLAGS "-mlongcalls -fstrict-volatile-bitfields -Wno-frame-address ${COMMON_DEFINE_FLAGS}" CACHE STRING "C++ compiler flags")
set(CPUCONFIG_ASMFLAGS "-mlongcalls -fstrict-volatile-bitfields -Wno-frame-address ${COMMON_DEFINE_FLAGS}" CACHE STRING "ASM compiler flags")
set(CPUCONFIG_LDFLAGS "-Wl,--gc-sections -Wl,-static -mlongcalls" CACHE STRING "Linker flags")
