...
#  define dmod_myapplication_dif(VERSION, RET, NAME, PARAMS)            \
                typedef RET (*dmod_myapplication##NAME##_t) PARAMS; \
                const char* const DMOD_MAKE_DIF_SIG_NAME(myapplication, NAME) = DMOD_MAKE_DIF_SIGNATURE(MyApplication, VERSION, NAME);
#  else
#  define dmod_myapplication_dif(VERSION, RET, NAME, PARAMS)            \
                typedef RET (*dmod_myapplication##NAME##_t) PARAMS; \
                _DMOD_DIF_SIGNATURE_REGISTRATION(DMOD_MAKE_DIF_SIG_NAME(myapplication, NAME), DMOD_MAKE_DIF_SIGNATURE(MyApplication, VERSION, NAME))
#  endif
#  define dmod_myapplication_dif_api_declaration(VERSION, IMPL_MODULE, RET, NAME, PARAMS)  \
