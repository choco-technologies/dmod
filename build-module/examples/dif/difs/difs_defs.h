...
#  define dmod_difs_dif(VERSION, RET, NAME, PARAMS)            \
                typedef RET (*dmod_difs##NAME##_t) PARAMS; \
                const char* const DMOD_MAKE_DIF_SIG_NAME(difs, NAME) = DMOD_MAKE_DIF_SIGNATURE(difs, VERSION, NAME);
#  else
#  define dmod_difs_dif(VERSION, RET, NAME, PARAMS)            \
                typedef RET (*dmod_difs##NAME##_t) PARAMS; \
                _DMOD_DIF_SIGNATURE_REGISTRATION(DMOD_MAKE_DIF_SIG_NAME(difs, NAME), DMOD_MAKE_DIF_SIGNATURE(difs, VERSION, NAME))
#  endif
#  define dmod_difs_dif_api_declaration(VERSION, IMPL_MODULE, RET, NAME, PARAMS)  \
