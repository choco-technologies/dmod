...
#  define dmod_dmodex_dif(VERSION, RET, NAME, PARAMS)            \
                typedef RET (*dmod_dmodex##NAME##_t) PARAMS; \
                const char* const DMOD_MAKE_DIF_SIG_NAME(dmodex, NAME) = DMOD_MAKE_DIF_SIGNATURE(dmodex, VERSION, NAME);
#  else
#  define dmod_dmodex_dif(VERSION, RET, NAME, PARAMS)            \
                typedef RET (*dmod_dmodex##NAME##_t) PARAMS; \
                _DMOD_DIF_SIGNATURE_REGISTRATION(DMOD_MAKE_DIF_SIG_NAME(dmodex, NAME), DMOD_MAKE_DIF_SIGNATURE(dmodex, VERSION, NAME))
#  endif
#  define dmod_dmodex_dif_api_declaration(VERSION, IMPL_MODULE, RET, NAME, PARAMS)  \
