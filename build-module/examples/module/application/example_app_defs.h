...
#  define dmod_example_app_dif(VERSION, RET, NAME, PARAMS)            \
                typedef RET (*dmod_example_app##NAME##_t) PARAMS; \
                const char* const DMOD_MAKE_DIF_SIG_NAME(example_app, NAME) = DMOD_MAKE_DIF_SIGNATURE(example_app, VERSION, NAME);
#  else
#  define dmod_example_app_dif(VERSION, RET, NAME, PARAMS)            \
                typedef RET (*dmod_example_app##NAME##_t) PARAMS; \
                _DMOD_DIF_SIGNATURE_REGISTRATION(DMOD_MAKE_DIF_SIG_NAME(example_app, NAME), DMOD_MAKE_DIF_SIGNATURE(example_app, VERSION, NAME))
#  endif
#  define dmod_example_app_dif_api_declaration(VERSION, IMPL_MODULE, RET, NAME, PARAMS)  \
