...
DMOD_LIBRARY_MODULE = 0
DMOD_APPLICATION_MODULE = 0

ifeq ($(DMOD_MODULE_TYPE),Library)
    DMOD_LIBRARY_MODULE = 1
else ifeq ($(DMOD_MODULE_TYPE),Application)
    DMOD_APPLICATION_MODULE = 1
endif
...
DMOD_DEFINITIONS    += DMOD_${DMOD_MODULE_NAME} \
            		   ...
            		   DMOD_MODULE=1 \
            		   DMOD_SYSTEM=0 \
					   DMOD_LIBRARY_MODULE=$(DMOD_LIBRARY_MODULE) \
					   DMOD_APPLICATION_MODULE=$(DMOD_APPLICATION_MODULE) \
					   $(DMOD_MAL_DEFS) \
					   $(DMOD_DIF_DEFS)
