...
ifneq ($(DMOD_MAIN_MODULE_NAME),)
	@$(TODMP) $(DMOD_PACKAGE_NAME) $(DMOD_DMF_DIR) -o $(DMOD_DMP_DMF_FILE_PATH) -m $(DMOD_MAIN_MODULE_NAME)
else
	@$(TODMP) $(DMOD_PACKAGE_NAME) $(DMOD_DMF_DIR) -o $(DMOD_DMP_DMF_FILE_PATH)
endif
ifneq ($(TODMFC),)
	@echo "  - DMFC package: $(DMOD_DMP_DMFC_FILE_PATH)"
ifneq ($(DMOD_MAIN_MODULE_NAME),)
	@$(TODMP) $(DMOD_PACKAGE_NAME) $(DMOD_DMFC_DIR) -o $(DMOD_DMP_DMFC_FILE_PATH) -m $(DMOD_MAIN_MODULE_NAME)
else
	@$(TODMP) $(DMOD_PACKAGE_NAME) $(DMOD_DMFC_DIR) -o $(DMOD_DMP_DMFC_FILE_PATH)
endif
endif
else
